...
const PersonaSelector: React.FC<PersonaSelectorProps> = ({ currentPersona, onPersonaChange }) => {
    ...
    const personas: { id: Persona; name: string; description: string; icon: string }[] = [
        { id: 'default', name: 'Aiko (Default)', description: 'Balanced and helpful', icon: '🤖' },
        { id: 'coding_expert', name: 'Dev Guru', description: 'Concise, code-focused, technical', icon: '👨‍💻' },
        { id: 'teacher', name: 'Sensei', description: 'Patient, explanatory, educational', icon: '🧑‍🏫' },
        { id: 'best_friend', name: 'Bestie', description: 'Casual, slang, fun, lots of emojis', icon: '👯' },
    ];
